...
# Streamlit UI
st.title("Doodle-Guesser Game 😄📝")
st.write("1.Airplane, 2.Bicycle, 3.Bird, 4.Birthday cake, 5.Candle, 6.Car, 7.Chair, 8.Cloud, 9.Fish, 10.Mountain, 11.Octopus, 12.Smiley face, 13.Table, 14.Tree, 15.Umbrella")
st.write("Draw your doodle 👇")
...
#col1, col2, col3 = st.columns(3, gap="medium")  # Adjust the ratio as needed
